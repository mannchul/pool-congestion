...
class TestWeekday:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (6, 0, 55, "보통"),  # 06:00~08:00 (morning PEAK based on real data)
            (7, 0, 55, "보통"),
            (7, 59, 55, "보통"),
            (8, 0, 45, "보통"),  # 08:00~10:00
            (9, 30, 45, "보통"),
            (10, 0, 40, "보통"),  # 10:00~11:00
            (10, 59, 40, "보통"),
            (11, 0, 12, "여유"),  # 11:00~12:00
            (11, 30, 12, "여유"),
            (11, 59, 12, "여유"),
            (12, 0, 0, "수질정화시간"),  # break
            (12, 30, 0, "수질정화시간"),
            (12, 59, 0, "수질정화시간"),
            (13, 0, 45, "보통"),  # 13:00~14:00 (afternoon peak)
            (14, 0, 25, "여유"),  # 14:00~15:00
            (14, 59, 25, "여유"),
            (15, 0, 22, "여유"),  # 15:00~16:00
            (15, 59, 22, "여유"),
            (16, 0, 28, "여유"),  # 16:00~18:00 (actual 28% from latest scrape)
            (17, 0, 28, "여유"),
            (17, 59, 28, "여유"),
            (18, 0, 12, "여유"),  # 18:00~20:00 (evening, very quiet)
            (19, 0, 12, "여유"),
            (20, 0, 12, "여유"),  # closing time included
...
class TestSunday:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (9, 0, 10, "여유"),
            (9, 59, 10, "여유"),
            (10, 0, 45, "보통"),  # 10:00~11:00 (based on real Sun data: 56 users)
            (10, 30, 45, "보통"),
            (10, 59, 45, "보통"),
            (11, 0, 40, "보통"),  # 11:00~12:00
            (11, 30, 40, "보통"),
            (11, 59, 40, "보통"),
            (12, 0, 20, "여유"),  # 12:00~13:00 (lunch dip: 17 users)
            (12, 30, 20, "여유"),
            (12, 59, 20, "여유"),
            (13, 0, 55, "보통"),  # 13:00~15:00
            (14, 0, 55, "보통"),
            (14, 59, 55, "보통"),
            (15, 0, 65, "보통"),  # 15:00~16:00 (PEAK: 60 users!)
            (15, 30, 65, "보통"),
            (15, 59, 65, "보통"),
            (16, 0, 25, "여유"),  # 16:00~17:00 (steep drop: 7 users)
            (17, 0, 25, "여유"),  # closing time included
            (17, 1, 10, "여유"),  # after close
            (18, 0, 10, "여유"),
            (23, 59, 10, "여유"),
        ],
...
class TestColourMapping:
    def test_green_below_30(self):
        r = _estimate_congestion(_dt(2026, 5, 25, 15, 0))  # weekday 22% -> green
        assert r["color"] == "#22c55e"

    def test_yellow_30_to_49(self):
        r = _estimate_congestion(_dt(2026, 5, 25, 10, 30))  # weekday 40% -> yellow
        assert r["color"] == "#eab308"

    def test_orange_50_to_69(self):
        r = _estimate_congestion(_dt(2026, 5, 25, 6, 30))  # weekday 55% -> orange
        assert r["color"] == "#f97316"

    def test_red_70_and_above(self):
        r = _estimate_congestion(_dt(2026, 5, 30, 12, 30))  # Sat 12:30, 80% -> red
