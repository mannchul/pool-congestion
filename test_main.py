...
class TestWeekday:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (6, 0, 35, "여유"),  # 06:00~08:00
            (7, 0, 35, "여유"),
            (7, 59, 35, "여유"),
            (8, 0, 25, "여유"),  # 08:00~10:00
            (9, 30, 25, "여유"),
            (10, 0, 15, "여유"),  # 10:00~11:00
            (10, 59, 15, "여유"),
            ...
            (12, 30, 0, "수질정화시간"),
            (12, 59, 0, "수질정화시간"),
            (13, 0, 30, "여유"),  # 13:00~14:00
            (14, 0, 22, "여유"),  # 14:00~15:00
            (14, 59, 22, "여유"),
            (15, 0, 18, "여유"),  # 15:00~16:00
            (15, 59, 18, "여유"),
            (16, 0, 18, "여유"),  # 16:00~18:00
            (17, 0, 18, "여유"),
            (17, 59, 18, "여유"),
            (18, 0, 15, "여유"),  # 18:00~20:00
            (19, 0, 15, "여유"),
            (20, 0, 15, "여유"),  # closing time included
...
class TestColourMapping:
    ...
    def test_orange_50_to_69(self):
        # Weekday now has max 35 in morning, use Saturday's high values
        r = _estimate_congestion(_dt(2026, 5, 30, 12, 30))  # Sat 12:30, 80% -> red
        # Use a slot that gives 50-69
        r2 = _estimate_congestion(_dt(2026, 5, 30, 10, 30))  # Sat 10:30, 65% -> orange
        assert r2["color"] == "#f97316"
